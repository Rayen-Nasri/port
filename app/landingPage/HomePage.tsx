...
export const HomePage = () => {
    return (
        <section className="text-white flex items-start lg:relative lg:bottom-20 z-0">
            <div className="w-full lg:grid grid-cols-1 lg:grid-cols-2 ">
                <div className="flex flex-col justify-center space-y-5 md:space-y-7 text-center lg:text-left px-4 lg:px-8">
                    ...
                    <div className="animate-slideUp">
                        <h1 className="text-[32px] md:text-[42px] lg:text-[52px] font-bold leading-tight bg-gradient-to-r from-white to-purple-400 bg-clip-text text-transparent">
                ...
                <div className="flex lg:block hidden items-start mt-8 lg:mt-0">
